      ...
      <!--  <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-4" href="index.html">SIDORABI WEDDING ORGANIZER</a></span>
            </div>
        </div>
                        ...
                        <div class="carousel-caption justify-content-center">
                            <div class="col-10 align-center">
                                ...
                                <div class="mbr-section-btn" buttons="0">
                                    <a class="btn  display-4 btn-success" href="viewCalender.html">RESERVATION, HERE ! </a>
...
<section class="features18 popup-btn-cards cid-r9u7YX24WL" id="features18-5" data-rv-view="409">
    ...
    <div class="container">
        ...
        Share Your Happines With Us&nbsp;</h3>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper ">
                    <div class="card-img">
                        ...
                        <img src="{{ asset('images/2c3852ad926664adc2372e09ba77bb3c-600x400-1-600x400.jpg') }}" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">RANDI &amp; TASYA</h4>
                        <p class="mbr-text mbr-fonts-style align-left display-7">M C &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Koko<br>Venue &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Taman Indie Resto<br>MUA &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : &nbsp;Byderganata<br>Entertaiment : Exodus Music<br>Dekorasi &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Peacock Decoration</p>
                    </div>
                </div>
            </div>
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <div class="mbr-overlay"></div>
                        <div class="mbr-section-btn text-center"><a href="index.html" class="btn btn-info display-4">MORE</a></div>
                        <img src="{{ asset('images/indonesia-sepekan-pernikahan-glenn-chelsea-putusnya-ayu-ting-ting-shaheer-sheikh-k0bv8wpsfp-7-800x500.jpg') }}" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">GLEEN &amp; CHELSEA</h4>
                        <p class="mbr-text mbr-fonts-style display-7">M C &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Koko
                            <br>Venue &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Taman Indie Resto
                            <br>MUA &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :  Byderganata
                            <br>Entertaiment &nbsp; : Exodus Music
                            <br>Dekorasi &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Peacock Dec</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card p-3 col-12 col-md-6 col-lg-4">
                    <div class="card-wrapper">
                        <div class="card-img">
                            <div class="mbr-overlay"></div>
                            <div class="mbr-section-btn text-center"><a href="index.html" class="btn btn-info display-4">MORE</a></div>
                            <img src="{{ asset('images/18382374-1723668464599822-1940946543410413568-n-d24487e7bd75b6f837f13a4ee7027beb-4-1080x1078.jpg') }}" alt="Mobirise" title="" media-simple="true">
                        </div>
                        <div class="card-box">
                            <h4 class="card-title mbr-fonts-style display-7">JEVIN &amp; RINIE</h4>
                            <p class="mbr-text mbr-fonts-style display-7">M C &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Koko
                                <br>Venue &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Taman Indie Resto
                                <br>MUA &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :  Byderganata
                                <br>Entertaiment &nbsp; : Exodus Music
