...
<body>
    ...
    <section class="carousel slide cid-rf6v1vH9z8" data-interval="false" id="slider1-1">
        <div class="full-screen">
            <div class="mbr-slider slide carousel" data-pause="true" data-keyboard="false" data-ride="carousel" data-interval="4000">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(images/05-klk-photography-ritz-carlton-2016-1400x926.jpg);">
                        <div class="container container-slide">
                            <div class="image_wrapper">
                                <div class="mbr-overlay" style="opacity: 0.2;"></div>
                                <img src="{{ asset('images/05-klk-photography-ritz-carlton-2016-1400x926.jpg') }}">
                                <div class="carousel-caption justify-content-center">
                                    <div class="col-10 align-center">
                                        <h2 class="mbr-fonts-style display-1">SIDO RABI WEDDING ORGANIZER</h2>
                                        <p class="lead mbr-text mbr-fonts-style display-5">Partner Pernikahan Anda</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item slider-fullscreen-image" data-bg-video-slide="https://www.youtube.com/watch?v=zNXhyvirfpQ&amp;index=1&amp;list=PLHI_rDpEUXmqe3ga9qKI6GVUyqFfs1cx7">
                        <div class="mbr-overlay" style="opacity: 0;"></div>
                        <div class="container container-slide">
                            <div class="image_wrapper">
                                <img src="{{ asset('images/2.jpg') }}" style="opacity: 0;">
                                <div class="carousel-caption justify-content-center">
                                    <div class="col-10 align-left">
                                        <h2 class="mbr-fonts-style display-1">VIDEO</h2>
                    ...
                    <div class="carousel-item slider-fullscreen-image active" data-bg-video-slide="false" style="background-image: url(images/182962-1280x782.jpg);">
                        <div class="container container-slide">
                            <div class="image_wrapper">
                                <div class="mbr-overlay" style="opacity: 0.1;"></div>
                                <img src="{{ asset('images/182962-1280x782.jpg') }}">
                                <div class="carousel-caption justify-content-center">
                                    <div class="col-10 align-right">
                                        <h2 class="mbr-fonts-style display-1">TIM KAMI</h2>
                                        <p class="lead mbr-text mbr-fonts-style display-5">Sido Rabi Wedding Organizer adalah sebuah perusahaan yang menawarkan one stop shop &nbsp;untuk pernikahan baik pernikahan tradisional maupun internasional dengan tim yang profesional dan berpengalaman</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="mbr-section article content9 cid-rf6YRYi8Oi" id="content9-b">
        <div class="container">
            <div class="inner-container" style="width: 100%;">
                <hr class="line" style="width: 25%;">
                <div class="section-text align-center mbr-fonts-style display-5">Sido Rabi Wedding Organizer adalah Perusahaan Penyedia Jasa blablabalalabal</div>
                <hr class="line" style="width: 25%;">
            </div>
        </div>
    </section>

    <section class="mbr-section content4 cid-rhAyaiqhZY" id="content4-1h">
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h2 class="align-center pb-3 mbr-fonts-style display-2">FOTO GALERI</h2>
                    <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">Kumpulan Foto Pernikahan Klien</h3>
                </div>
            </div>
        </div>
    </section>

    <section class="mbr-gallery mbr-slider-carousel cid-rf6Z7AFwAv" id="gallery1-c">
        <div class="container">
            <div><!-- Filter --><!-- Gallery -->
                <div class="mbr-gallery-row">
                    <div class="mbr-gallery-layout-default">
                        ...
                        <div data-app-prevent-settings="" class="mbr-slider modal fade carousel slide" tabindex="-1" data-keyboard="true" data-interval="false" id="lb-gallery1-{{ $gallery->id }}">
                                    ...
                                    <div class="modal-body">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active">
                                                <img src="/storage/{{$photo->path}}" alt="" title="">
                                            </div>
                                            @else
                                        ...
                                        <a class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#lb-gallery1-{{ $gallery->id }}">
                                            <span class="mbri-left mbr-iconfont" aria-hidden="true"></span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                        <a class="carousel-control carousel-control-next" role="button" data-slide="next" href="#lb-gallery1-{{ $gallery->id }}">
